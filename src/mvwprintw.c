 ...
 *
 * $Log:	mvwprintw.c,v $
 * Revision 1.1  91/09/07  11:44:33  sie
 * Initial revision
 * 
 *
 */

static char *rcsid = "$Header: SRC:lib/curses/src/RCS/mvwprintw.c,v 1.1 91/09/07 11:44:33 sie Exp $";

#include "acurses.h"
#include <stdarg.h>


mvwprintw(WINDOW *WinPtr, short int Line, short int Col, char *fmt, ...)
{
  int Ret;
  char buffer[BUFSIZ];
  va_list ap;
