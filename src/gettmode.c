 ...
 *
 *
 * Filename : SRC:lib/curses/src/gettmode.c
 *
 * Author   : Simon J Raybould.    (sie@fulcrum.co.uk).
 *
 * Date     : Wed Jan 20 22:16:04 1993
 *
 * Desc     : gettmode()
 *
 *
...
#ifndef lint
static char *rcsid = "$Header: /SRC/lib/curses/src/RCS/gettmode.c,v 1.1 1993/05/17 23:33:10 sie Exp $";
#endif /* lint */
